//building a board using javascript functions
for (var i = 0; i < 3; i++) {
  for (var j = 0; j < 3; j++) {
    console.log("Row: " + i);
...
function myfunc() {
  //DOM input field to grab elements value
  ...
  // Checking if Player 2 starts, If player 2 won or
  ...
  // Checking about Tie
    ...
    window.alert("Ohh Grasshopper, your Game is Good!");
  } else {
    //print result
    if (flag == 1) {
...
//functions checking turn of Player
//value X or 0
flag = 1;
function myfunc_3() {
  if (flag == 1) {
